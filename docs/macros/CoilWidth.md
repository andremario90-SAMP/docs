...
**CoilWidth** calcola la larghezza effettiva della batteria (coil) in base alle dimensioni interne della sezione e al tipo di casing.
...
Restituisce un valore `Double` che rappresenta la larghezza della batteria in millimetri (mm).
...
| `dWidth` | `SE.OUT.IntWidth` | Larghezza interna sezione (mm) |
...
La larghezza della batteria è ridotta rispetto alla larghezza interna della sezione per tenere conto di:
- Spessore profili laterali
...
' - Larghezza interna: 920 mm

' Calcolo:
' CoilWidth = 920 - 40 = 880 mm
```
...
' - Larghezza interna: 1530 mm

' Calcolo:
' CoilWidth = 1530 - 60 = 1470 mm
```
...
' - Larghezza interna: 2450 mm

' Calcolo:
' CoilWidth = 2450 - 60 = 2390 mm
```
...
Le batterie sono disponibili in dimensioni standard. La larghezza calcolata deve corrispondere a una dimensione disponibile a catalogo.
...
- Verificare compatibilità con circuiti idraulici
